...
class DynamicQuestionGenerator {
  ...
  static Future<List<Question>> generateQuestionsFromContent(
    String content,
    String category, {
    String language = 'en',
  }) async {
    try {
      ...
      if (isApiKeyValid) {
        final questions = await _generateQuestionsWithAI(
          content,
          category,
          language: language,
        );
        if (questions.isNotEmpty) {
          print(
            'Successfully generated ${questions.length} questions for category: $category in $language using AI',
          );
          return questions;
        }
      }
    ...
    print(
      'Using local question generation for category: $category in $language',
    );
    try {
      final questions =
          await LocalQuestionGenerator.generateQuestionsFromContent(
            content,
            category,
            language: language,
          );
      if (questions.isNotEmpty) {
        print(
          'Successfully generated ${questions.length} questions for category: $category in $language using local generation',
        );
        return questions;
      }
    } catch (e) {
  ...
  static Future<List<Question>> _generateQuestionsWithAI(
    String content,
    String category, {
    String language = 'en',
  }) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonMatch != null) {
          ...
          print(
            'Successfully generated ${questions.length} questions for category: $category',
          );
  ...
  static Future<bool> validateAnswerWithAI(
    String question,
    String userAnswer,
    ...
    if (!isApiKeyValid) {
      ...
      return LocalQuestionGenerator.validateAnswer(
        question,
        userAnswer,
        correctAnswer,
        bookContent,
  ...
  static Future<String> generateExplanationWithAI(
    String question,
    String answer,
    String bookContent,
  ) async {
    if (!isApiKeyValid) {
      ...
      return LocalQuestionGenerator.generateExplanation(
        question,
        answer,
        bookContent,
      );
  ...
  static Future<List<Question>> generateQuestionsByChapter(
    String chapter,
  ) async {
  ...
  static List<Question> generateFallbackQuestions(
    String category, {
    String language = 'en',
  }) {
    ...
    final questions =
        fallbackQuestions[category] ?? fallbackQuestions['Advertising Basics']!;
    return questions.asMap().entries.map((entry) {
      final index = entry.key;
      final q = entry.value;
      ...
      return Question(
        id:
            '${category}_fallback_${DateTime.now().millisecondsSinceEpoch}_$index',
        question: q['question'] as String,
        options: options,
  ...
  _getEnglishFallbackQuestions() {
    return <String, List<Map<String, dynamic>>>{
      'Advertising Basics': [
        {
          'question':
              'What are the two key players in the digital advertising ecosystem?',
          'options': [
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'The advertiser-publisher relationship is fundamental to digital advertising, where advertisers want to reach their target audience and publishers provide the content that attracts that audience.',
        },
        {
          'question':
              'What is the primary goal of an advertiser in digital advertising?',
          'options': [
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Advertisers want to get their product or service in front of their target audience to build brand awareness, develop brand loyalty, and increase sales.',
        },
        {
          'question': 'What does AdTech refer to in digital advertising?',
          'options': [
            'Software and tools for digital advertising',
            'Advertising content',
            'User data',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Advertising technology refers to the software and tools used to create, run, manage, measure, and optimize digital advertising campaigns.',
        },
        {
          'question':
              'Which of the following is NOT a typical participant in the digital advertising ecosystem?',
          'options': [
            'Content creators',
            'Ad networks',
            'Data providers',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'While content creators may be involved, the main ecosystem participants are advertisers, agencies, publishers, ad networks, ad exchanges, data providers, and technology platforms.',
        },
        {
          'question':
              'What has significantly evolved the digital advertising ecosystem?',
          'options': [
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'The ecosystem has evolved significantly with the introduction of programmatic advertising, which automates the buying and selling of ad inventory.',
        },
      ],
      'AdTech Platforms': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'First-party ad servers are owned and operated by publishers, while third-party ad servers are independent technology platforms.',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Real-Time Bidding (RTB) is an automated auction process for buying and selling ad impressions in real-time.',
        },
        {
          'question': 'What is the primary function of a DSP?',
          'options': [
            'To buy ad inventory from multiple sources',
            'To sell ad inventory',
            'To collect user data',
            'To create ad content',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Demand-Side Platforms (DSPs) allow advertisers to buy ad inventory from multiple sources through a single interface.',
        },
        {
          'question': 'What is the main purpose of header bidding?',
          'options': [
            'To increase competition and publisher revenue',
            'To reduce ad load times',
        ...
        },
        {
          ...
          'options': [
            'Digital marketplace for ad space',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Ad exchanges are digital marketplaces that enable advertisers and publishers to buy and sell ad space in real-time.',
        },
      ],
      'Targeting and Data': [
        {
        ...
        {
          'question':
              'What does behavioral targeting use to serve relevant ads?',
          'options': [
            'User actions and browsing history',
            'Webpage content',
            'Geographic data',
        ...
        },
        {
          ...
          'options': [
            'To collect, organize, and activate audience data',
            'To create ad content',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Data Management Platforms (DMPs) collect, organize, and activate audience data for advertising.',
        },
        {
          'question': 'What is lookalike targeting used for?',
          'options': [
            'Finding new potential customers similar to existing ones',
      ...
      'Media Buying': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Programmatic media buying uses technology to automate the buying and selling of ad inventory.',
        },
        {
          'question': 'What is a Private Marketplace (PMP)?',
          'options': [
            'Invitation-only marketplace for premium inventory',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Private Marketplaces (PMP) are invitation-only marketplaces where premium ad inventory is sold to select advertisers.',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'In second-price auctions, the winner pays the second-highest bid amount.',
        },
        {
          'question':
              'What is the main advantage of header bidding for publishers?',
          'options': [
            'Increased competition and higher revenue',
            'Faster ad loading',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Header bidding allows publishers to offer their inventory to multiple ad exchanges simultaneously, increasing competition and revenue.',
        },
        {
          'question':
              'Which method is NOT typically part of programmatic advertising?',
          'options': [
            'Manual negotiation',
            'Real-Time Bidding',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Manual negotiation is not part of programmatic advertising, which is automated. RTB, PMP, and Programmatic Direct are all programmatic methods.',
        },
      ],
      'User Identification': [
        {
          ...
          'options': [
            'To identify and track users across websites',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Cookies are small text files used to identify and track users across websites for advertising purposes.',
        },
        {
          'question': 'What is device fingerprinting?',
          'options': [
            'Identifying devices based on unique characteristics',
        ...
        },
        {
          ...
          'options': [
            'Tracking user behavior across apps and websites',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Advertising IDs are unique identifiers assigned to mobile devices for advertising and tracking purposes.',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'User identification is becoming more challenging due to privacy regulations and browser restrictions on third-party cookies.',
        },
        {
          'question': 'What is cross-device identification used for?',
          'options': [
            'Recognizing the same user across multiple devices',
            'Creating device profiles',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Cross-device identification allows advertisers to recognize the same user across multiple devices.',
        },
      ],
      'Ad Fraud and Privacy': [
        {
          ...
          'options': [
            'Deliberate deception to generate invalid impressions',
            'Accidental ad misplacement',
            'Poor ad performance',
            'Technical errors',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Ad fraud involves deliberate deception to generate invalid ad impressions or clicks, costing advertisers billions annually.',
        },
        {
          'question': 'What is ad viewability?',
          'options': [
            'Whether ads are actually seen by users',
        ...
        },
        {
          ...
          'options': [
            'User data and consumer control',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Privacy regulations like GDPR protect user data and give consumers control over how their information is collected and used.',
        },
        {
          'question': 'What is brand safety?',
          'options': [
            'Ensuring ads appear in appropriate contexts',
            'Protecting brand logos',
            'Managing brand reputation',
            'Creating brand guidelines',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Brand safety measures ensure that ads appear in appropriate contexts and don\'t appear alongside content that could damage a brand\'s reputation.',
        },
        {
          'question':
              'What is the typical viewability standard for display ads?',
          'options': [
            '50% visible for 1 second',
            '100% visible for 1 second',
            '25% visible for 2 seconds',
            '75% visible for 0.5 seconds',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Viewability standards typically require 50% of the ad to be visible for at least 1 second.',
        },
      ],
      'Attribution': [
        {
          ...
          'options': [
            'Assigning credit for conversions to touchpoints',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Attribution is the process of assigning credit for conversions to specific touchpoints in the customer journey.',
        },
        {
          'question': 'What is cross-device attribution?',
          'options': [
            'Tracking behavior across multiple devices',
        ...
        },
        {
          ...
          'options': [
            ...
            'Only the first touchpoint',
            'Only the last touchpoint',
            'Only direct traffic',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Multi-touch attribution models consider all touchpoints in the customer journey, not just the first or last interaction.',
        },
        {
          'question': 'What is last-click attribution?',
          'options': [
            'Giving all credit to the final touchpoint',
            'Giving credit to all touchpoints',
            'Giving credit to the first touchpoint',
            'Giving equal credit',
          ],
          'correctAnswerIndex': 0,
          'explanation':
        ...
        },
        {
          ...
          'options': [
            'It may not reflect true contribution of each touchpoint',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'First-click attribution gives all credit to the initial touchpoint, which may not accurately reflect the true contribution of each touchpoint.',
        },
      ],
      'Personalization & A/B Testing': [
        {
          ...
          'options': [
            'To tailor messages to individual users',
            'To automate workflows',
            'To increase ad spend',
            'To reduce content creation',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Personalization aims to deliver relevant content and experiences to each user based on their preferences and behavior.',
        },
        {
          'question': 'What does A/B testing help marketers determine?',
          'options': [
            'Which version of content performs better',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'A/B testing compares two versions of a webpage or app to see which one achieves better results.',
        },
        {
          'question':
              'Which of the following is NOT a use case for A/B testing?',
          'options': [
          ...
          'explanation':
              'Managing customer data is not a direct use case for A/B testing.',
        },
      ],
      'Marketing Automation': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Marketing automation platforms help automate tasks like email campaigns, lead nurturing, and workflow management.',
        },
        {
          'question':
              'Which of the following is a feature of marketing automation?',
          'options': [
            'Lead nurturing',
            'Manual data entry',
            'Offline advertising',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Lead nurturing is a core feature of marketing automation platforms.',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Drip campaigns are automated sets of emails sent based on specific timelines or user actions.',
        },
      ],
      'CRM': [
        {
        ...
        {
          'question':
              'Which of the following is a primary function of a CRM system?',
          'options': [
            'Managing customer data',
            'Sending mass emails',
            'Designing websites',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'CRM systems are used to manage and analyze customer interactions and data.',
        },
        {
      ...
      'Email Marketing': [
        {
          'question':
              'What is a common metric to measure email marketing success?',
          'options': [
            'Open rate',
            'Page load time',
            'Ad impressions',
        ...
        },
        {
          ...
          'options': [
            'A list of people who have opted in to receive emails',
            'A list of website pages',
            'A list of ad campaigns',
            'A list of CRM contacts only',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'A subscriber list is a collection of email addresses of people who have opted in to receive communications.',
        },
      ],
      'Content Marketing': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Content marketing aims to attract and retain customers by creating valuable content.',
        },
        {
        ...
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Editorial calendars help marketers plan and schedule content publication.',
        },
      ],
      'Social Media Marketing': [
        {
          'question':
              'Which platform is commonly used for B2B social media marketing?',
          'options': ['LinkedIn', 'Instagram', 'Snapchat', 'Pinterest'],
          'correctAnswerIndex': 0,
          'explanation':
              'LinkedIn is widely used for B2B social media marketing.',
        },
        {
          'question': 'What is a social media campaign?',
          'options': [
            'A coordinated marketing effort on one or more platforms',
            'A type of email automation',
            'A CRM feature',
            'A web analytics tool',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'A social media campaign is a coordinated effort to reinforce or assist with a business goal using one or more social media platforms.',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Engagement refers to how users interact with social media content.',
        },
      ],
      'Web Analytics': [
        {
        ...
        },
        {
          ...
          'options': [
            ...
            'The number of social posts',
            'The number of CRM deals',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'Conversion rate measures how many visitors complete a desired goal out of the total number of visitors.',
        },
      ],
      'Customer Data Platforms': [
        {
          ...
          'options': [
            'A system that unifies customer data from multiple sources',
            'A type of CRM',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'A CDP collects and unifies customer data from multiple sources to create a single customer profile.',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'CDPs enable better segmentation and personalization for marketing.',
        },
        {
          'question': 'What is identity resolution in the context of CDPs?',
          'options': [
            'Matching data from different sources to the same customer',
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'Identity resolution is the process of matching data from different sources to a single customer profile.',
        },
      ],
    };
  }
    ...
    return <String, List<Map<String, dynamic>>>{
      'Advertising Basics': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              '広告主とパブリッシャーの関係はデジタル広告の基本であり、広告主はターゲットオーディエンスにリーチしたいと考え、パブリッシャーはそのオーディエンスを引き付けるコンテンツを提供します。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              '広告主は、ターゲットオーディエンスの前に自社の製品やサービスを提示して、ブランド認知度を高め、ブランドロイヤルティを育成し、売上を増やしたいと考えています。',
        },
        {
          'question': 'デジタル広告におけるAdTechとは何を指しますか？',
          'options': [
            'デジタル広告のためのソフトウェアとツール',
            '広告コンテンツ',
            'ユーザーデータ',
            'マーケティング戦略',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              '広告技術（AdTech）とは、デジタル広告キャンペーンの作成、実行、管理、測定、最適化に使用されるソフトウェアとツールを指します。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'コンテンツクリエイターも関与する場合がありますが、主要なエコシステム参加者は広告主、エージェンシー、パブリッシャー、アドネットワーク、アドエクスチェンジ、データプロバイダー、技術プラットフォームです。',
        },
        {
      ...
      'AdTech Platforms': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'ファーストパーティアドサーバーはパブリッシャーが所有・運営し、サードパーティアドサーバーは独立した技術プラットフォームです。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'リアルタイム入札（RTB）は、広告インプレッションの売買をリアルタイムで行う自動化されたオークションプロセスです。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'デマンドサイドプラットフォーム（DSP）は、広告主が単一のインターフェースを通じて複数のソースから広告在庫を購入できるようにします。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'ヘッダー入札により、複数のアドエクスチェンジが同時に広告在庫に入札でき、競争とパブリッシャーの収益が増加します。',
        },
        {
          'question': 'アドエクスチェンジはどのような種類のマーケットプレイスですか？',
          'options': [
            '広告スペースのデジタルマーケットプレイス',
            '物理的マーケットプレイス',
            'ソーシャルメディアプラットフォーム',
            'コンテンツ管理システム',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'アドエクスチェンジは、広告主とパブリッシャーがリアルタイムで広告スペースを売買できるデジタルマーケットプレイスです。',
        },
      ],
      'Targeting and Data': [
        {
        ...
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'リターゲティングは、以前にウェブサイトを訪問したユーザーやブランドとインタラクションしたユーザーに広告を表示します。',
        },
        {
          'question': 'DMPの主な機能は何ですか？',
          'options': [
            'オーディエンスデータの収集、整理、アクティベーション',
            '広告コンテンツの作成',
            '広告キャンペーンの管理',
            'コンバージョンの追跡',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'データ管理プラットフォーム（DMP）は、広告のためのオーディエンスデータを収集、整理、アクティベーションします。',
        },
        {
          'question': 'ルックアライクターゲティングは何のために使用されますか？',
          'options': [
            '既存顧客と類似した新しい潜在顧客を見つける',
            '競合他社をターゲットにする',
            '新しいオーディエンスを作成する',
            '市場動向を分析する',
          ],
      ...
      'Media Buying': [
        ...
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'プライベートマーケットプレイス（PMP）は、プレミアム広告在庫が選択された広告主に販売される招待制マーケットプレイスです。',
        },
        {
        ...
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'ヘッダー入札により、パブリッシャーは在庫を複数のアドエクスチェンジに同時に提供でき、競争と収益が増加します。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              '手動交渉は自動化されたプログラム化広告の一部ではありません。RTB、PMP、プログラム化ダイレクトはすべてプログラム化方法です。',
        },
      ],
      'User Identification': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'クッキーは、広告目的でウェブサイト間でユーザーを識別・追跡するために使用される小さなテキストファイルです。',
        },
        {
          'question': 'デバイスフィンガープリンティングとは何ですか？',
          'options': [
            'ユニークな特徴に基づいてデバイスを識別する',
            'デバイスプロファイルを作成する',
            'デバイスの位置を追跡する',
            'デバイス設定を管理する',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'デバイスフィンガープリンティングは、ブラウザ設定、画面解像度、インストールされたフォントなどのユニークな特徴に基づいてデバイスを識別します。',
        },
        {
          'question': '広告IDは何のために使用されますか？',
          'options': [
            'アプリとウェブサイト間でユーザー行動を追跡する',
            'ユーザーアカウントを作成する',
            'アプリ権限を管理する',
            'ユーザーデータを保存する',
          ],
        ...
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'ユーザー識別は、プライバシー規制とサードパーティクッキーに対するブラウザ制限により、より困難になっています。',
        },
        {
          'question': 'クロスデバイス識別は何のために使用されますか？',
          'options': [
            '複数のデバイス間で同じユーザーを認識する',
            'デバイスプロファイルを作成する',
            '複数のアカウントを管理する',
            'デバイスパフォーマンスを追跡する',
          ],
      ...
      'Ad Fraud and Privacy': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              '広告詐欺は、無効な広告インプレッションやクリックを生成するための意図的な欺瞞を含み、広告主に年間数十億ドルの損失を与えています。',
        },
        {
          'question': '広告の視認性とは何ですか？',
          'options': [
            '広告が実際にユーザーに見られているかどうか',
            '広告のクリック率',
            '広告パフォーマンス指標',
            '広告配置の質',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              '広告の視認性は、広告が実際にユーザーに見られているかどうかを測定し、通常は広告の50%が少なくとも1秒間表示される必要があります。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'GDPRなどのプライバシー規制は、ユーザーデータを保護し、消費者に情報の収集・使用方法に関する管理権を与えます。',
        },
        {
          'question': 'ブランドセーフティとは何ですか？',
          'options': [
            '広告が適切なコンテキストで表示されることを確保する',
            'ブランドロゴを保護する',
            'ブランド評判を管理する',
            'ブランドガイドラインを作成する',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'ブランドセーフティ対策により、広告が適切なコンテキストで表示され、ブランドの評判を損なう可能性のあるコンテンツと一緒に表示されることを防ぎます。',
        },
        {
      ...
      'Attribution': [
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'アトリビューションは、コンバージョンのクレジットをカスタマージャーニーの特定のタッチポイントに割り当てるプロセスです。',
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'クロスデバイスアトリビューションは、複数のデバイス間でユーザー行動とコンバージョンを追跡し、カスタマージャーニーの完全なビューを提供します。',
        },
        {
          'question': 'マルチタッチアトリビューションモデルは何を考慮しますか？',
          'options': [
            'カスタマージャーニーのすべてのタッチポイント',
            '最初のタッチポイントのみ',
            '最後のタッチポイントのみ',
            'ダイレクトトラフィックのみ',
          ],
          'correctAnswerIndex': 0,
          'explanation':
              'マルチタッチアトリビューションモデルは、最初または最後のインタラクションだけでなく、カスタマージャーニーのすべてのタッチポイントを考慮します。',
        },
        {
          'question': 'ラストクリックアトリビューションとは何ですか？',
          'options': [
            'すべてのクレジットを最終タッチポイントに与える',
            'すべてのタッチポイントにクレジットを与える',
            '最初のタッチポイントにクレジットを与える',
            '平等にクレジットを与える',
          ],
          'correctAnswerIndex': 0,
        ...
        },
        {
          ...
          'correctAnswerIndex': 0,
          'explanation':
              'ファーストクリックアトリビューションは、すべてのクレジットを初期タッチポイントに与えますが、各タッチポイントの真の貢献を正確に反映しない可能性があります。',
        },
      ],
      'Personalization & A/B Testing': [
        {
